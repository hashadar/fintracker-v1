...
if df is not None and not df.empty:
    ...
    if not cash_df.empty:
        ...
        latest_month, prev_month, ytd_start_month = get_asset_type_time_periods(df, ASSET_TYPES['CASH'])
        ...
        # --- Portfolio Analytics ---
        create_portfolio_analytics_charts(df, asset_type=ASSET_TYPES['CASH'], section_title="Cash Analytics", section_icon="📈")
