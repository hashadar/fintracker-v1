...
from utils.design.cards import complex_emphasis_card, complex_card
...
if df is not None and not df.empty:
    ...
    # --- Portfolio Analytics ---
    create_portfolio_analytics_charts(df, asset_type=None, section_title="Portfolio Analytics", section_icon="📈")
