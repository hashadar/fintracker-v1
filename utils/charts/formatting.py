...
from utils.config import CURRENCY_SYMBOL, SHORT_DATE_FORMAT
...
def apply_consistent_axis_formatting(
    fig, x_format=None, y_format=None, x_label=None, y_label=None
):
    """
